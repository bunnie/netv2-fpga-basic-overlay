...
-- Command     : write_vhdl -force -mode funcsim -rename_top overlay1_util_ds_buf_6_3 -prefix overlay1_util_ds_buf_6_3_
--               overlay1_util_ds_buf_6_0_sim_netlist.vhdl
...
entity \overlay1_util_ds_buf_6_3_util_ds_buf\ is
  port (
  ...
  attribute C_BUF_TYPE of \overlay1_util_ds_buf_6_3_util_ds_buf\ : entity is "IBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of \overlay1_util_ds_buf_6_3_util_ds_buf\ : entity is 1;
end \overlay1_util_ds_buf_6_3_util_ds_buf\;

architecture STRUCTURE of \overlay1_util_ds_buf_6_3_util_ds_buf\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \overlay1_util_ds_buf_6_3\ is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of \overlay1_util_ds_buf_6_3\ : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of \overlay1_util_ds_buf_6_3\ : entity is "overlay1_util_ds_buf_6_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of \overlay1_util_ds_buf_6_3\ : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of \overlay1_util_ds_buf_6_3\ : entity is "util_ds_buf,Vivado 2016.1";
end \overlay1_util_ds_buf_6_3\;

architecture STRUCTURE of \overlay1_util_ds_buf_6_3\ is
...
begin
U0: entity work.\overlay1_util_ds_buf_6_3_util_ds_buf\
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
